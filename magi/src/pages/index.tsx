...
function CollectionExample({ setNumColumns, setNumRows, numColumns, numRows }) {
...
function PrecisionExample({ numColumns }) {
    return (
        <TextureCardStyled>
            <TextureCardHeader className="text-center pl-3">
                <GradientHeading variant="light" size="xs">Columns</GradientHeading>
            </TextureCardHeader>
            <TextureCardContent>
                <div className="flex gap-2">
                    <div
                        className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-sky-500 to-indigo-500"
...
function CostExample({ numColumns, numRows }) {
    ...
    return (
        <TextureCardStyled>
            ...
            <TextureCardContent>
                <div className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-sky-500 to-indigo-500" style={{ minWidth: "120px", textAlign: "center" }}>
...
function OgImageSection() {
    ...
    return (
        <div className="w-full flex flex-col gap-2 justify-between pt-6">
            <CollectionExample setNumColumns={setNumColumns} setNumRows={setNumRows} numColumns={numColumns} numRows={numRows} />
        </div>
    )
}
